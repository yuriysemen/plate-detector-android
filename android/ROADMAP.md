...
- [ ] **Upload authentication** — Cognito Identity Pool guest credentials replace the current unsigned API calls; SigV4-signed requests to IAM-protected API Gateway (REQ-014, REQ-018)
