...
> [`../android-training-data-collection-app/ARCHITECTURE.md`](../android-training-data-collection-app/ARCHITECTURE.md) instead. What
...
/ `LEGACY_EXTERNAL` values for type-shape parity with `android-training-data-collection-app`, but they're never
produced here.
